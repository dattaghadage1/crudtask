      ...
      <form onSubmit={SendData}>
        <div className="row" style={{ display: "flex", justifyContent: "center" }}>
          <div className="four columns" style={{ textAlign: "center" }}>
           ...
           <input className="u-full-width" type="text" placeholder="id" value={empid} name='id'  onChange={(e)=>getInput(e)} /> 
            <label htmlFor="exampletextInput">Name</label>
            <input className="u-full-width" type="text" placeholder="name" value={data.name} name="name" onChange={(e) => getInput(e)} />
            <label htmlFor="exampletextInput">Age</label>
            <input className="u-full-width" type="text" placeholder="age" name='age' value={data.age} onChange={(e) => getInput(e)} />
            <label htmlFor="exampletextInput">City</label>
            <input className="u-full-width" type="text" placeholder="city" name='city' value={data.city} onChange={(e) => getInput(e)} />
